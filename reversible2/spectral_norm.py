...
class SpectralNorm(object):
    ...
    def __init__(
        self, to_norm, name="weight", n_power_iterations=1, dim=0, eps=1e-12
    ):
    ...
    @staticmethod
    def apply(module, name, to_norm, n_power_iterations, dim, eps):
        ...
        fn = SpectralNorm(to_norm, name, n_power_iterations, dim, eps)
...
def spectral_norm(
    module, name="weight", to_norm=1, n_power_iterations=1, eps=1e-12, dim=None
):
    ...
    if dim is None:
        if isinstance(
            ...
            dim = 0
    SpectralNorm.apply(module, name, to_norm, n_power_iterations, dim, eps)
    return module
